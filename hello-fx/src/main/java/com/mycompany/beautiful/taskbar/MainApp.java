...
public class MainApp extends Application {
    ...
    public void start(Stage stage) throws FileNotFoundException {
        ...
        Node node = createButton("/icon0.png", new Runnable() {
            @Override
            public void run() {
        ...
        node = createButton("/icon1.png", new Runnable() {
            @Override
            public void run() {
                // оси координат
        ...
        node = createButton("/icon2.png", new Runnable() {
        ...
        node = createButton("/icon3.png", new Runnable() {
            @Override
            public void run() {
        ...
        node = createButton("/icon4.png", new Runnable() {
            @Override
            public void run() {
