    ...
    private ImageView initButtonDetailsImage(String imgPath, int actionType) {
        ...
        initDetailsImage.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                try {
                    //http://128.199.185.171:8080/sound-backend-api-application/sound?category=%s&details=%s&language=%s
                    //http://128.199.185.171:8080/sound-backend-api-application/sound?category=c0&details=0&language=ch
                   ...
                   // String str = props.get("sound.path")+"";
                    ...
                    /*String str = "http://128.199.185.171:8080/sound-backend-api-application/sound?category=c0&details=0&language=ch";
                    ...
                    //AudioClip soundMyNoise = new AudioClip("http://128.199.185.171:8080/sound-backend-api-application/sound?category=c0&details=0&language=ch");


                    ;
                    //AudioClip soundMyNoise = new AudioClip(new File("ch.m4a").toURI().toString());
                    AudioClip soundMyNoise = new AudioClip(getClass().getResource("/ch.m4a").toURI().toString());
                    soundMyNoise.play();
