...
public class Shelf extends Region {
    ...
    public Shelf(Image[] images, DetailsView detailsView) {
        ...
        scrollBar.valueProperty().addListener(new InvalidationListener() {
            public void invalidated(Observable ov) {
                if (!localChange) {
                    ...
                    //System.out.println("shift; index="+scrollBar.getValue());
    ...
    public void shift(int shiftAmount) {
        ...
        //System.out.println("\tIndex:"+detailsView.selectedDetails);
        update();
    }
}
