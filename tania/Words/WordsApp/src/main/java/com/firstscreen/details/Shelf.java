...
public class Shelf extends Region {
    ...
    public Shelf() {
       ...
       // getChildren().addAll(centered, scrollBar);
        clip.setStyle("-fx-background-color: yellow;");
        setStyle("-fx-background-color: yellow;");
        clip.setFill(Paint.valueOf("yellow"));
        // set clip
    ...
    public void refresh(){
        cleanup();
        refresh(images, detailsView);
    }
    
    private void refresh(Image[] images, DetailsView detailsView) {
        clip.setStyle("-fx-background-color: yellow;");
        setStyle("-fx-background-color: yellow;");
        // set clip
        setClip(clip);        
      ...
      //  scrollBar.setStyle("-fx-base: #202020; -fx-background: #202020;");
        ...
        for (int i = 0; i < images.length; i++) {
            final PerspectiveImage item = items[i] = new PerspectiveImage(images[i], i);
